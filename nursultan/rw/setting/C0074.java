...
public class C0074 extends NUZ {
   private final NNNBL f1000;
   private final NNNBL f2000;

   public C0074(NNNBL var1) {
      super(var1);
   ...
   public static NNSR m2000() {
      ...
      var2.N("shell", NNSi.L().N(0, 0).N(-7.0F, -10.0F, -7.0F, 14.0F, 10.0F, 16.0F, new NNSu(0.2F)), NNSy.N(0.0F, -13.0F, 5.0F));
