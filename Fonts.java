...
public class Fonts {
    ...
    public static final Supplier<MsdfFont> CRICKCLIENT = Suppliers.memoize(() -> MsdfFont.builder().atlas("crickclient").data("crickclient").build());
    ...
    /** Replace atlas after generating MSDF from Schulevetica-Regular.otf. */
    public static final Supplier<MsdfFont> SCHULEVETICA = Suppliers.memoize(() -> MsdfFont.builder().atlas("schulevetica").data("schulevetica").build());

    public static final Supplier<MsdfFont> GUI_TITLE = SCHULEVETICA;
    /** Cyrillic body text until Schulevetica MSDF atlas is generated from the .otf. */
    public static final Supplier<MsdfFont> GUI_BODY = SFREGULAR;
}