...
public class ClickGuiThemeSelector {
    public void render(DrawContext context, Window window, float offsetY, float alphaMul, int shadeColor) {
        ...
        List<fun.crickclient.api.storages.implement.ThemeStorage.Themes> themes = CrickClient.INSTANCE.themeStorage.getThemeList();
        ...
        fun.crickclient.api.storages.implement.ThemeStorage.Themes selected = CrickClient.INSTANCE.themeStorage.getThemes();
        for (int i = 0; i < themes.size(); i++) {
            fun.crickclient.api.storages.implement.ThemeStorage.Themes theme = themes.get(i);
    ...
    private int getThemeDisplayColor(fun.crickclient.api.storages.implement.ThemeStorage.Themes theme) {
