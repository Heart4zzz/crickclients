...
import fun.crickclient.client.modules.impl.render.base.implement.*;
...
public class Interface extends Module {
    ...
    private static final boolean PERF_DEBUG = Boolean.parseBoolean(System.getProperty("crickclient.perf.debug", "false"));
    private static final long SLOW_HUD_ELEMENT_NANOS = Long.getLong("crickclient.perf.hudMs", 5L) * 1_000_000L;
    private static final long PERF_WARN_COOLDOWN_NANOS = Long.getLong("crickclient.perf.cooldownMs", 1000L) * 1_000_000L;
    ...
    public Interface() {
        ...
        this.waterMark = new WaterMark(CrickClient.draggable(this, "WaterMark", 10, 10));
        this.arrayListHud = new ArrayListHud(CrickClient.draggable(this, "ArrayList", 5, 24));
        this.keyBinds = new KeyBinds(CrickClient.draggable(this, "KeyBinds", 30, 30));
        this.helperBinds = new HelperBinds(CrickClient.draggable(this, "HelperBinds", 90, 30));
        this.potions = new Potions(CrickClient.draggable(this, "Potions", 30, 60));
        this.staffList = new StaffList(CrickClient.draggable(this, "StaffList", 60, 100));
        this.session = new Session(CrickClient.draggable(this, "Session", 70, 30));
        this.keyStrokes = new KeyStrokes(CrickClient.draggable(this, "KeyStrokes", 150, 120));
        this.information = new Information(CrickClient.draggable(this, "Information", 50, 100));
        this.notifications = new Notifications(CrickClient.draggable(this, "Notifications", 0, 0));
        this.targetHud = new TargetHud(CrickClient.draggable(this, "TargetHud", 30, 90));
    }
