...
import fun.crickclient.mixin.ChatScreenAccessor;
...
public class NameProtect extends Module {
    ...
    private final TextSetting nickname = new TextSetting("Никнейм", "crickclient", 32);
    ...
    public String patch(String text) {
        ...
        if (friends.isState() && CrickClient.INSTANCE != null && CrickClient.INSTANCE.friendStorage != null) {
            for (String friend : CrickClient.INSTANCE.friendStorage.getFriends()) {
    ...
    public String getReplacementName() {
        ...
        return value == null || value.isBlank() ? "crickclient" : value;
    }
    ...
    private String patchGrief(String text) {
        ...
        String out = text.replaceAll("Анархия-\\d+", "crickclient.fun");
        out = out.replaceAll("ГРИФ #\\d+", "crickclient.fun");
        return out;
    }
    ...
    private String getPatchCacheKey(String text) {
        ...
        int friendsHash = 0;
        if (friends.isState() && CrickClient.INSTANCE != null && CrickClient.INSTANCE.friendStorage != null) {
            List<String> friendList = CrickClient.INSTANCE.friendStorage.getFriends();
    ...
    private boolean isFriendRemoveInputActive() {
        ...
        TextFieldWidget chatField = ((ChatScreenAccessor) chatScreen).crickclient$getChatField();
        if (chatField == null) {
            return false;
        }
        ...
        String prefix = CrickClient.INSTANCE != null && CrickClient.INSTANCE.commandStorage != null
                ? CrickClient.INSTANCE.commandStorage.getPrefix().toLowerCase()
                : ".";
