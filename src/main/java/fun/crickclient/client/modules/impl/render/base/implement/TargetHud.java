...
public class TargetHud extends InterfaceProcessing {
    ...
    public void DefaultStyle(EventRender.Default eventRender) {
        ...
        int colorTheme2;
        if (!CrickClient.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")) {
            colorTheme2 = ColorUtils.darken(CrickClient.INSTANCE.themeStorage.getThemes().getTheme().color[0], 0.4f);
        } else {
    ...
    public void WaveStyle(EventRender.Default eventRender) {
        ...
        int waveThemeColor = !CrickClient.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")
