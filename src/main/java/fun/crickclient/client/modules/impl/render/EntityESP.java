...
import fun.crickclient.api.utils.render.font.ReplaceSymbols;
...
import fun.crickclient.client.modules.impl.misc.ScoreboardHP;
...
public class EntityESP extends Module {
    ...
    private void drawTag(EventRender.Default event, PlayerEntity player, ScreenRect rect, Font font) {
        ...
        String rightBracket = "";
        boolean isFriend = CrickClient.INSTANCE.friendStorage != null
    ...
    private boolean isRainbowTheme() {
        if (CrickClient.INSTANCE == null || CrickClient.INSTANCE.themeStorage == null || CrickClient.INSTANCE.themeStorage.getThemes() == null) {
            return false;
        }
        var theme = CrickClient.INSTANCE.themeStorage.getThemes().getTheme();
