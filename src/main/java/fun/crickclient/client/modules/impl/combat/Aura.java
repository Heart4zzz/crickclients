...
import fun.crickclient.api.events.implement.EventGameUpdate;
...
import fun.crickclient.api.utils.combat.PredictUtils;
import fun.crickclient.api.utils.input.MovingUtil;
import fun.crickclient.api.utils.math.MathUtils;
...
import fun.crickclient.api.utils.rotate.MultipointUtils;
...
import fun.crickclient.client.modules.impl.combat.components.rotations.WellMineRotation;
import fun.crickclient.client.modules.impl.combat.components.rotations.WhiteRiseRotation;
import fun.crickclient.client.modules.impl.movement.Sprint;
import fun.crickclient.client.modules.impl.player.AutoEat;
...
public class Aura extends Module {
    ...
    private boolean isValidTarget(LivingEntity entity) {
        ...
        if (entity instanceof PlayerEntity player) {
            ...
            if (CrickClient.INSTANCE.friendStorage.isFriend(entity.getName().getString())) return false;
