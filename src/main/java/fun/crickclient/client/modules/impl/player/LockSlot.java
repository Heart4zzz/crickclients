...
import fun.crickclient.mixin.SlotAccessor;
...
public class LockSlot extends Module {
    ...
    private int getHotbarSlotFromClick(int slotId) {
        ...
        int inventoryIndex = accessor.crickclient$getIndex();
        if (accessor.crickclient$getInventory() == mc.player.getInventory() && inventoryIndex >= 0 && inventoryIndex <= 8) {
