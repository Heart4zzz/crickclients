package fun.crickclient.client.modules.settings.implement;
...
public class ModeSetting extends Setting {
    ...
    public String displayMode(String mode) {
        return CrickClient.INSTANCE.localizationStorage == null ? mode : CrickClient.INSTANCE.localizationStorage.translate(mode);
    }
