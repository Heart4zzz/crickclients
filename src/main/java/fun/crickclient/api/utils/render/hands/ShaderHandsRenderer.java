package fun.crickclient.api.utils.render.hands;
...
import fun.crickclient.client.modules.impl.render.ShaderHands;
...
public class ShaderHandsRenderer implements QClient {
    ...
    public void renderOverlayIfPending() {
        ...
        int color1 = CrickClient.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")
    ...
    private ShaderHands getModule() {
        if (CrickClient.INSTANCE == null || ModuleClass.INSTANCE == null) return null;
