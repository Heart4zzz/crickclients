package fun.crickclient.api.utils.render.fonts.msdf;
...
public final class MsdfFont implements QClient {
    ...
    public static class Builder {
        ...
        public Builder data(String dataFileName) {
            this.dataIdentifier = Identifier.of("crickclient", "fonts/msdf/" + dataFileName + "/font.json");
            return this;
        }

        public Builder atlas(String atlasFileName) {
            this.atlasIdentifier = Identifier.of("crickclient", "fonts/msdf/" + atlasFileName + "/font.png");
            return this;
        }
