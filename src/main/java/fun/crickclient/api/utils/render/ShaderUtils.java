package fun.crickclient.api.utils.render;
...
public class ShaderUtils implements QClient {
    ...
    private ShaderProgramKey register(String shaderNamePackage, String shaderName, VertexFormat vertexFormat) {
        return new ShaderProgramKey(Identifier.of("crickclient", "core/" + shaderNamePackage + "/" + shaderName), vertexFormat, Defines.EMPTY);
    }
}
